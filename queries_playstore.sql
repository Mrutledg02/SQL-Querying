...
SELECT app_name, COUNT(*) AS num_reviews FROM analytics GROUP BY app_name ORDER BY num_reviews DESC LIMIT 5;

-- Find the app that has the most reviews with a rating greater than equal to 4.8.
SELECT app_name, COUNT(*) AS num_reviews FROM reviews WHERE rating >= 4.8 GROUP BY app_name ORDER BY num_reviews DESC LIMIT 1;
...
SELECT app_name, reviews, min_installs, CAST(min_installs AS FLOAT) / reviews AS proportion FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;
